...
# @jit(nopython=True)
def shadowingfunction_20(a, azimuth, altitude, scale, amaxvalue, forsvf):
    ''' Adapted by LB, rm all references to vegdsm, commented out, then added back in?'''
    # plt.ion()
...
# Trying to reflect the fact that we don't have a veg dsm
        tempvegdem[xp1:xp2, yp1:yp2] = tempvegdem[xc1:xc2, yc1:yc2] - dz
        tempvegdem2[xp1:xp2, yp1:yp2] = tempvegdem2[xc1:xc2, yc1:yc2] - dz
